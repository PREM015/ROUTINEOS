          ...
          {features.map((feature) => {
            ...
            return (
              <Link
                key={feature.href}
                href={feature.href}
                className="flex flex-col items-center justify-center p-3 rounded-xl bg-card border border-border hover:border-primary/50 hover:bg-muted/50 transition-all text-center group"
              >
